...
# -*- coding: utf-8 -*-
"""
Nasdaq 100 / Small-Mid Cap - Trading Signal Scanner v2
Melhorias vs v1:
  - Score ponderado (nao binario)
  - Confirmacao de candle direcional
  - Tendencia macro (SMA50 vs SMA200)
  - Volume medio sobre 50 dias (mais estavel)
  - ATR normalizado pelo preco (%)
  - RSI com zonas nao sobrepostas
  - Filtro de volatilidade minima
  - Filtro de consistencia de tendencia (% de dias acima/abaixo EMA20)
...
Uso:
    ...
    python scanner.py --universe smallcap
"""
